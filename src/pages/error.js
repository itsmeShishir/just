    ...
    <div className="py-16 w-full min-h-screen flex justify-center md:items-center bg-white">
      <div className="mx-auto max-w-xl lg:max-w-4xl flex flex-col lg:flex-row">
        ...
        <div className="px-5">
          ...
          <Link to="/" type="button" className="mt-10 relative inline-flex items-center px-7 py-3.5 rounded border border-transparent bg-indigo-600 md:text-lg text-white font-medium hover:bg-indigo-700">
            Go back to Homepage
          </Link>
        </div>
